...
GraphStat1DContinue::GraphStat1DContinue(EtudeStat1D& E1,QWidget *parent) :
    QMainWindow(parent),
...
float	M[5];
int i = 0;
memcpy(M,E1.getMode(),sizeof(float)*5);
